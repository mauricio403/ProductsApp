...
import { checkingCredentials, clearErrorMessage, onLogin, onLogout, authState } from './authSlice';
...
export const startRegister = (nombre: string, correo: string, password: string) => {
    return async (dispatch: AppDispatch) => {
